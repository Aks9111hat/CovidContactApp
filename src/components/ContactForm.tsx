...
const ContactForm: React.FC<ContactFormProps> = ({ onContactAdded }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center p-5 rounded bg-sky-400'>
            ...
            <button type="submit" className='p-3 rounded bg-cyan-300'>Add Contact</button>
        </form>
    );
};
