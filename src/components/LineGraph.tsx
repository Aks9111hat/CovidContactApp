...
const LineGraph: React.FC = () => {
    ...
    return (
        <div className='text-center text-xl'>
            ...
            <div className='flex justify-around m-5 gap-4'>
                <button className='transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-emerald-600 duration-300 p-2 rounded-lg bg-emerald-400' onClick={handleCaseGraphButtonClick}>Show cases Graph</button>
                <button className='transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-emerald-600 duration-300 p-2 rounded-lg bg-emerald-400' onClick={handleRecoveredGraphButtonClick}>Show Recovered Graph</button>
                <button className='transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-emerald-600 duration-300 p-2 rounded-lg bg-emerald-400' onClick={handleDeathGraphButtonClick}>Show Deaths Graph</button>
            </div>
            <div>
